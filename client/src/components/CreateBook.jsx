  ...
  return (
    <div className="createbook">
      ...
      <div className="createbook-header">
        <h1 className="createbook-title">Adicionar Livro</h1>
        <p className="createbook-text">Criar novo livro</p>
      </div>
      <br/>
      <form className="form" noValidate onSubmit={onSubmit}>
        ...
        <div className="form-group">
          <input
            type="text"
            placeholder="Descreva este livro"
            name="description"
            className="form-control"
        ...
        <div className="form-group">
          <input
            type="text"
            placeholder="Editora deste livro"
            name="publisher"
            className="form-control"
